...
--Q2: Sinh viên tiến hành viết câu lệnh nhập dữ liệu cho CSDL QuanLyGiaoVu.
...
--Q4: Sinh viên hoàn thành Phần I bài tập QuanLyGiaoVu từ câu 9, 11 đến câu 14.
    ...
    CK_TC CHECK(CONVERT(INT, TCTH) - CONVERT(INT, TCLT) <= 3)
