...
--Q1: Sinh viên tiến hành viết câu lệnh nhập dữ liệu cho CSDL QuanLyBanHang.
...
--Q3: Sinh viên hoàn thành Phần II bài tập QuanLyBanHang từ câu 2 đến câu 5.
    ...
    UPDATE SANPHAM1 
    SET GIA = GIA * 0.95 WHERE NUOCSX = 'Trung Quoc' AND GIA <= 10000
    ...
    --II 5: Cập nhật giá trị LOAIKH là “Vip” đối với những khách hàng đăng ký thành viên trước ngày 1/1/2007 có doanh số từ 10.000.000 trở lên hoặc khách hàng đăng ký thành viên từ 1/1/2007 trở về sau có doanh số từ 2.000.000 trở lên (cho quan hệ KHACHHANG1).
...
--Q5: Sinh viên hoàn thành Phần III bài tập QuanLyBanHang từ câu 1 đến câu 7.
